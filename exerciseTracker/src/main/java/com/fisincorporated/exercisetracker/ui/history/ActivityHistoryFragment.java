...
import com.fisincorporated.exercisetracker.ui.utils.ActivityHistoryItemAdapter;
...
public class ActivityHistoryFragment extends ExerciseMasterFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void showExerciseFilter() {
        ...
        dialog.setTargetFragment(ActivityHistoryFragment.this, EXERCISE_REQUESTCODE);
    ...
    public void showLocationFilter() {
        ...
        locDialog.setTargetFragment(ActivityHistoryFragment.this,
    ...
    public static class ListCursorLoader extends SQLiteCursorLoader {
        ...
        ActivityHistoryFragment alf;

        // public ListCursorLoader(Context context,DeletePriorActivitiesFragment
        // palf) {
        public ListCursorLoader(Context context, ActivityHistoryFragment alf) {
            super(context);
            this.alf = alf;
        }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor){
        if (activityHistoryItemAdapter == null) {
            activityHistoryItemAdapter = new ActivityHistoryItemAdapter(getContext(), callBacks);
    ...
    //TODO structure for subclass
    // Stuff from ActivityHistoryListFragment

    public void onListItemClick(ListView l, View v, int position, long id) {
        Bundle args = new Bundle();
        args.putLong(TrackerDatabase.LocationExercise._ID, id);
        ...
        args.putString(TrackerDatabase.LocationExercise.DESCRIPTION, (String) ((TextView) v.findViewById(R.id.prior_activity_row_description)).getText()) ;
