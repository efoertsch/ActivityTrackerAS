...
public class ActivityLoggerServiceFragment extends ExerciseDaggerFragment {
...
//            if (location != null) {
//                Snackbar.make(layoutView, "Location :" + location.toString(),
//                        Snackbar.LENGTH_SHORT).show();
//            }
        }
    }

    public static ActivityLoggerServiceFragment newInstance(Bundle bundle) {
        Bundle args = new Bundle();
        args.putBundle(GlobalValues.BUNDLE, bundle);
        ActivityLoggerServiceFragment fragment = new ActivityLoggerServiceFragment();
