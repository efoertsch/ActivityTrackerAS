 ...
 */
public class ExerciseTrackerFacebookBroadcastReceiver extends FacebookBroadcastReceiver {
	private static final String TAG = "ExerciseTrackerFacebookBroadcastReceiver";
    @Override
