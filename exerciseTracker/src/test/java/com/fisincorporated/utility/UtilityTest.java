...
//    }
    ...
    public void testCalcMarkerLessThan1Mile() throws Exception {
        // 1609 meters  < 1 mile
        assertEquals("testCalcMarkerDistance failed. 1609 meters < 1 mi", Utility.coveredDistanceForMarker(1609, true, 1), false);
    }

    @Test
    public void testCalcMarker1Mile() throws Exception {
        // 1610 meters just over 1 mile
        assertEquals("testCalcMarkerDistance failed. 1610 meters = 1 mi", Utility.coveredDistanceForMarker(1610, true, 1), true);
    }

    @Test
    public void testCalcMarkerOver1Mile() throws Exception {
        // 1620 meters   over 1 mile
        assertEquals("testCalcMarkerDistance failed. 1610 meters = 1 mi", Utility.coveredDistanceForMarker(1620, true, 1), true);
    ...
    public void testCalcMarkerUnder2Mile() throws Exception {
        // 3218 meters  < 2 mile
        assertEquals("testCalcMarkerDistance failed. 3218 meters < 2 mi", Utility.coveredDistanceForMarker(3218, true, 2), false);
    ...
    public void testCalcMarkerOver2Mile() throws Exception {
        // 3240 meters  > 2 mile
        assertEquals("testCalcMarkerDistance failed. 3240 meters > 2 mi", Utility.coveredDistanceForMarker(3240, true, 2), true);
    ...
    public void testCalcMarkerUnder1KmDistance() throws Exception {
        ...
        assertEquals("testCalcMarkerDistance failed. 999 meters < 1 km", Utility.coveredDistanceForMarker(999, false, 1), false);
    ...
    public void testCalcMarker1KmDistance() throws Exception {
        ...
        assertEquals("testCalcMarkerDistance failed. 1000 meters = 1 km", Utility.coveredDistanceForMarker(1000, false, 1), true);
    }

    @Test
    public void testCalcMarkerOver1KmDistance() throws Exception {
        // 1001 meters  over 1 kilometer
        assertEquals("testCalcMarkerDistance failed. 1001 meters > 1 km", Utility.coveredDistanceForMarker(1001, false, 1), true);
    }

    @Test
    public void testCalcMarkerOver2KmDistance() throws Exception {
        // 2001 meters  over 2 kilometer
        assertEquals("testCalcMarkerDistance failed. 2001 meters > 2 km", Utility.coveredDistanceForMarker(2001, false, 2), true);
